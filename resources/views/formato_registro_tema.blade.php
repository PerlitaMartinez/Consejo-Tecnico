        ...
        <div class="col-14">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">Registro de Tema</h2>
                </div>
                <div class="card-body">
                    ...
                    <br />
                    <br />
                    <label for="" class="form-label">De la manera más atenta me dirijo a ustedes, solicitando autorización para desarrollar el Trabajo Recepcional previo a la presentación de mi Examen Profesional, con este fin proporciono los datos siguientes:</label>
                </div>
                <div class="card-body">
                                <form id="formulario" method="GET" action="{{ route('registroTemaPdf.show') }}" target="_blank">
                       ...
                       <!-- <div class="form-group">
                        ...
                        <label for="inputPassword5" class="form-label">DOMICILIO:</label>
                        <input class="form-control form-control-sm" type="text" disabled value="Álvaro Obregón 64, Centro, 78300 San Luis, S.L.P.">

                        <label for="inputPassword5" class="form-label">TELEFONO:</label>
                        <input class="form-control form-control-sm" type="text" disabled value="444 326 9203">

                        <label for="inputPassword5" class="form-label">TEMA PROPUESTO:</label>
                        <input class="form-control form-control-sm" type="text" disabled value="Desarrollo de la habilidad emprendedora en estudiantes normalistas mediante la metodología de Aprendizaje Orientado a Proyectos">

                        <label for="inputPassword5" class="form-label">ASESOR PROPUESTO:</label>
                        <input class="form-control form-control-sm" type="text" disabled value="M.I. VITAL OCHOA OMAR">

                        <!--<label for="inputPassword5" class="form-label">CO-ASESOR PROPUESTO:</label>
                        <input class="form-control form-control-sm" type="text" disabled value="DRA. NAVA MUÑOZ SANDRA EDITH">-->
