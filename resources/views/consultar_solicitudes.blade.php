...
document.addEventListener('DOMContentLoaded', function () {
    ...
    consultarBtn.addEventListener('click', function () {
        ...
        if (criterioSeleccionado === 'clave_unica') {
            var claveUnicaValor = claveUnicaInput.value.trim();
...
<div class="custom-container mt-4">
    ...
    <div class="row mt-4 justify-content-center">
        ...
        <div class="col-md-3">
            <input id="claveUnicaInput" type="text" class="form-control" placeholder="Clave única" oninput="validarClaveUnica(event)" disabled style="height: 100%; width: 100%">
        </div>
        <div class="col-md-3">
            <button type="button" class="btn btn-primary" id="consultarBtn" style="height: 100%; width: 80%">Consultar</button>
        </div>
    </div>
