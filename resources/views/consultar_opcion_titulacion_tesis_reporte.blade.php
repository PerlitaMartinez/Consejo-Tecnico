...
<div class="container"> 
    <h2>Consulta Solicitudes De Opcion de Titulacion de Tesis de Lic.</h2>
    ...
    <table class="table">
        <thead class="thead-light">
            <tr>
                ...
                <th class="text-center">Estado Tesis</th>
                <th class="text-center">Fecha de Sesion de Tesis</th>
