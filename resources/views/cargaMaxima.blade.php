         ...
         <div class="col-14">
            <div class="card">
                <div class="card-header">
                    <h2 class="text-center">Solicitud Carga Maxima</h2>
                </div>
                <div class="card-body">
             ...
             autorizacion para continuar mis estudios en esta Facultad, debido a que:</label>
                </div>
                 <div class="card-body">
...
<table class="table table-striped table-hover">
  ...
  <tbody>
    <tr>
        ...
        <td><input class="form-check-input" type="radio" name="" id="checkbox1" checked></td>
    </tr>
    <tr>
        <td>INSCRIBI UNA VEZ Y MEDIA LA DURACION DE LA CARRERA</td> 
        <td><input class="form-check-input" type="radio" name="" id="checkbox2" checked></td>
