...
<div class="container"> 
    <h2>Consulta Solicitudes De Opcion de Titulacion</h2>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <h6> Opcion de Titulacion </h6>
        <select class="form-select btn btn-primary">
          <!-- Opciones del tercer select -->
          <option selected>TRABAJO RECEPCIONAL</option>
          <option selected>MEMORIAS DE ACTIVIDAD </option>
        </select>
      </div>
    ...
    <table class="table">
        <thead class="thead-light">
            <tr>
                ...
                <th class="text-center">Opcion de Titulacion</th>
