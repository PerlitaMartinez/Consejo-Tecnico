                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                                type="button" role="tab" aria-controls="nav-home" aria-selected="false">Asesor y
                                Coasesor</button>
                            ...
                            <div class="col-md-8">
                                <div class="form-group d-flex">
                                    ...
                                    <input type="text" id="Asesor" class="form-control"
                                        placeholder="Nombre Asesor" value="Alberto Ramirez Blanco" readonly>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group d-flex">
                                    @foreach ($coasesor as $nom)
                                        ...
                                        <input type="text" id="Coasesor" class="form-control" readonly
                                            ...
                                            value="{{ $nom->nombre_coasesor }}">
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade show active" id="nav-direccion" role="tabpanel"
                            ...
                            @foreach ($datosA as $datos)
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="calleA" class="form-control" readonly
                                            placeholder="Nombre de la calle" name="txtcalle"
                                            value="{{ $datos->calle_alumno }}">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="coloniaA" class="form-control" readonly
                                            placeholder="Nombre de la colonia" name="txtcolonia"
                                            value="{{ $datos->colonia_alumno }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        <label for="noEA" class="mr-2" style="">No. Ext:</label>
                                        <input type="text" id="noEA" class="form-control" readonly
                                ...
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="noIA" class="form-control" readonly
                                ...
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="cp" class="form-control" readonly
                                            placeholder="Codigo Postal" name="txtcp" value="{{ $datos->cp_alumno }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                            ...
                            <div class="col-md-10">
                                <div class="form-group d-flex">
                                    @foreach ($tema as $tem)
                                        ...
                                        <input type="text" class="form-control" readonly name="txtTema"
                                            value="{{ $tem->tema }}"></input>
                                    @endforeach
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" data-bs-toggle="modal"
                                                        data-bs-target="#ModalEditar" class="btn btn-info"><i
                                ...
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="nombre" class="form-control" name="txtnombreE"
                                            placeholder="Nombre de la empresa" value="{{ $datE->nombre_empresa }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="colonia" class="form-control" name="txtcoloE"
                                            placeholder="Nombre de la colonia" value="{{ $datE->colonia_empresa }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="noE" class="form-control" readonly
                                            name="txtnEE" placeholder="Numero de exterior"
                                            value="{{ $datE->num_exterior_empresa }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        <label for="noI" class="mr-2" style="">No. Int:</label>
                                        <input type="text" id="noI" class="form-control" readonly
                                            name="txtnIE" placeholder="Numero Interior"
                                            value="{{ $datE->num_interior_empresa }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="cp" class="form-control" name="txtcpE"
                                            readonly placeholder="Codigo Postal" value="{{ $datE->cp_empresa }}">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="email" class="form-control" name="txtemailEm"
                                            placeholder="Correo Electronico empresa" value="{{ $datE->correo_empresa }}"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group d-flex">
                                        ...
                                        <input type="text" id="telefono" class="form-control" name="txtteleE"
                                            placeholder="Telefono de la empresa" value="{{ $datE->telefono_empresa }}"
                                            readonly>
                                    </div>
                                </div>
                            @endforeach
                ...
                @else
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link active " id="nav-contact-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-direccion" type="button" role="tab"
                                aria-controls="nav-direccion" aria-selected="true">Datos Generales</button>
                            <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                                type="button" role="tab" aria-controls="nav-home" aria-selected="false">Asesor y
                                Coasesor</button>
                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-tema" type="button" role="tab" aria-controls="nav-profile"
                                aria-selected="false">Tema y
                                Temario</button>
                            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-empresa" type="button" role="tab" aria-controls="nav-contact"
                                aria-selected="false">Datos de la
                                Empresa</button>
