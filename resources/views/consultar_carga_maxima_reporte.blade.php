...
<div class="container"> 
    <h2>Consulta Solicitudes De Carga Maxima</h2>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <h6> Tipo De Carga Maxima </h6>
        <select class="form-select btn btn-primary">
          <!-- Opciones del tercer select -->
          <option selected>Materias Reprobadas</option>
          <option selected> Duracion y media </option>
        </select>
      </div>
    ...
    <table class="table">
        <thead class="thead-light">
            <tr>
                ...
                <th class="text-center">Materias Reprobadas</th>
                <th class="text-center">Duracion Y Media</th>
