...
<div class="custom-container mt-4">
    <h1>Consultar Solicitud Carga Máxima</h1>
    ...
    <form action="{{ route('solicitudUpdateCM', ['id' =>$id]) }}" method="POST">
        @csrf
        @method('POST')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group d-flex">
                    ...
                    <span id="clave_unica" name="clave_unica" class="form-control">{{$data->id_solicitud_cm}}</span>
                </div>
            </div>
        </div>
        <div class="row">
